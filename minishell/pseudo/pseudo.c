...
/*   Updated: 2021/08/31 18:10:24 by mchun            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv, char **envp)
{
	...
	*/
	...
	argv_split(list);				// list 안의 arg_string을 quote를 신경써서 char **arg로 나눈다.
	/*
		1. list 안의 arg_string 에 대해서 variable expansion을 진행한다.
		2. list의 enum 변수 type이 COMMAND 인 것을 찾은 뒤 (연결리스트 traverse)
		...
		3. list의 enum 변수 type이 BUILT_IN 인것을 찾은 뒤 (연결리스트 traverse)
